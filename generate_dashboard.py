...
# 2. SELECTIONS & STYLING CONFIGURATION
...
MAP_WIDTH, MAP_HEIGHT = 800, 450
BAR_WIDTH, BAR_HEIGHT = 800, 450
SCATTER_WIDTH, SCATTER_HEIGHT = 800, 450
...
# VIEW 2: SCATTER PLOT 1 (Economic Size vs Population)
...
# VIEW 3: SCATTER PLOT 2 (Interest Rate vs Inflation Rate)
...
# 3. LAYOUT ASSEMBLY & EXPORT
spacer_vertical = alt.Chart(pd.DataFrame({'x': [0]})).mark_text(text='').properties(width=1, height=40)

top_row = alt.hconcat(final_map, view4, spacing=10)
bottom_row = alt.hconcat(view2, view3, legend, spacing=50)
...
print("Dashboard compiled successfully into 'my_dashboard.html'!")
